...
import { Users, Calendar, FileText, PieChart, AlertTriangle, Bell } from "lucide-react";
...
import { Event, AAR, VeniceAnalysis as VeniceAnalysisType, Unit, User as UserType } from "@/lib/types";
...
export default function Dashboard() {
    ...
    try {
      ...
      if (data.success) {
        toast({
          ...
          description: "A test notification has been sent. Check the notification bell in the header.",
          variant: "default",
        });
      } else {
        toast({
  ...
  const { data: veniceAnalysis = {
    trends: [],
    frictionPoints: [],
    recommendations: []
  } as VeniceAnalysisType } = useQuery<VeniceAnalysisType>({
